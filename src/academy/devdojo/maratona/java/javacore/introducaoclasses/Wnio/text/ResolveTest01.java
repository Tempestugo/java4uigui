...
public class ResolveTest01 {
    public static void main(String[] args) {
        ...
        // sem barra no começo, é um caminho relativo
        // com barra especifica que é do root , caminho absoluto


    }

}
//Path base = Paths.get("file.txt").getParent();
//Path destino = base.resolve("dev");
//